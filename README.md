...
1. Clone the repo
   ```sh
   git clone https://github.com/paulofelipebrito/landing-page-for-sales
   ```
...
Project Link: [https://github.com/paulofelipebrito/landing-page-for-sales](https://github.com/paulofelipebrito/landing-page-for-sales)
